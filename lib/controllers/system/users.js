...
//     { "name": "name", "requid": true, "filter": "like", "rename": "u.name" },
//     { "name": "nickname", "requid": true, "filter": "like" },
//     { "name": "roleid", "requid": true, "filter": true },
//     { "name": "account", "requid": true, "filter": "like" },
//     { "name": "email", "filter": "like" },
...
//   /** 根据用户账号,获取用户详细信息 */
//   "info": (req, res) => {
//     var userid = req.query.userid;//base64.decode(req.query.userid);
//     if (userid == "") {
